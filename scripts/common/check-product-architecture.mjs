...
try {
  ...
  ok(fs.existsSync(path.join(root, 'docs/prompts/0.1.79-unified-ai-first-architecture.md')), '0.1.79 正式需求必须归档到 docs/prompts')
  ok(fs.existsSync(path.join(root, 'docs/releases/0.1.79.md')), '0.1.79 必须存在版本记录')
