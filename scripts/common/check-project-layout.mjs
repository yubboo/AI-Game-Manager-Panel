...
const requiredPaths = [
  ...
  'scripts/common/check-minecraft.mjs',
  'internal/games/minecraft/service.go',
  'internal/games/minecraft/facts.go',
  'internal/games/minecraft/runtime.go',
  'internal/games/minecraft/probe.go',
  'internal/server/instance/store.go',
  'frontend/src/games/minecraft/MinecraftWorkspace.vue',
  'frontend/src/games/minecraft/MinecraftInstance.vue',
