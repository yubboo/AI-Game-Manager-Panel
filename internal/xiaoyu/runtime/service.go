...
//
// 0.2.16 keeps the same Host-authorized cross-platform Terminal RPC and fixes the concrete windows-sys 0.61.2 ConPTY ABI type mismatches exposed by the Windows Runner. Go remains the source
...
// primitives in 0.2.16, including Linux PTY and Windows ConPTY/resize; model-visible execution still goes through AGMP Tool
