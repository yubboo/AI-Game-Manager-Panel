...
//
// 0.2.13 keeps Host-authorized Terminal RPC on the supervised persistent Rust worker and adds Linux native PTY/resize behind the same contract. Go remains the source
...
// primitives in 0.2.13, including Linux native PTY/resize; model-visible execution still goes through AGMP Tool
