...
//
// 0.2.14 keeps Host-authorized Terminal RPC on the supervised persistent Rust worker and adds Windows ConPTY beside the Linux native PTY backend. Go remains the source
...
// primitives in 0.2.14, including Linux PTY and Windows ConPTY/resize; model-visible execution still goes through AGMP Tool
