...
/// truth for game/product domain services. The 0.2.18 input convergence keeps the same
...
impl Runtime {
    ...
    /// PTY and Windows uses ConPTY; 0.2.18 requires the Windows Runner to exercise
