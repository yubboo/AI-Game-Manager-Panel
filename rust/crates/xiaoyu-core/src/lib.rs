...
/// truth for game/product domain services. The 0.2.19 input convergence keeps the same
...
impl Runtime {
    ...
    /// PTY and Windows uses ConPTY; 0.2.19 requires the Windows Runner to exercise
